...
|---------------------------------------------|-----------------------------------|----------------|----------------------|------------------|---------------------|---------------|----------------------------|------------------------|-------------------|-------------------|-----------------|------------------|-------------|-------------|-------------|------------|--------------------------------|
| its_associated_with_security_groups         | YES                               | YES            | YES                  | -                | DRILLED             | YES           | YES                        | YES                    | -                 | YES               | YES             | YES              | -           | -           | -           | -          |                                |
| ├─ its_associated_with_network_interfaces   |                                   |                |                      |                  |                     |               |                            |                        |                   |                   |                 |                  |             |             |             |            |                                |
| ├─ its_associated_with_ec2_instances        |                                   |                |                      |                  |                     |               |                            |                        |                   |                   |                 |                  |             |             |             |            |                                |
| ├─ its_associated_with_ips_public           |                                   |                |                      |                  |                     |               |                            |                        |                   |                   |                 |                  |             |             |             |            |                                |
| ├─ its_associated_with_managed_services     |                                   |                |                      |                  |                     |               |                            |                        |                   |                   |                 |                  |             |             |             |            |                                |
...
| └─ is_default                               |                                   |                |                      |                  |                     |               |                            |                        |                   |                   |                 |                  |             |             |             |            |                                |
|                                             |                                   |                |                      |                  |                     |               |                            |                        |                   |                   |                 |                  |             |             |             |            |                                |
| its_associated_with_iam_roles               | YES                               | YES            | YES                  | -                | -                   | YES           | -                          | -                      | YES (Not Drilled) | YES               | YES             | YES              | -           | -           | -           | DRILLED    |                                |
...
| └─  is_unrestricted                         |                                   |                |                      |                  |                     |               |                            |                        |                   |                   |                 |                  |             |             |             |            |                                |
|                                             |                                   |                |                      |                  |                     |               |                            |                        |                   |                   |                 |                  |             |             |             |            |                                |
| its_associated_with_iam_policies            | -                                 | -              | -                    | -                | -                   | -             | -                          | -                      | DRILLED           | -                 | -               | -                | -           | -           | -           | YES        |                                |
| ├─ it_has_name                              |                                   |                |                      |                  |                     |               |                            |                        |                   |                   |                 |                  |             |             |             |            |                                |
| ├─ it_has_description                       |                                   |                |                      |                  |                     |               |                            |                        |                   |                   |                 |                  |             |             |             |            |                                |
| ├─ is_attached                              |                                   |                |                      |                  |                     |               |                            |                        |                   |                   |                 |                  |             |             |             |            |                                |
| ├─ is_customer_managed                      |                                   |                |                      |                  |                     |               |                            |                        |                   |                   |                 |                  |             |             |             |            |                                |
