...
| AwsElastiCacheCacheCluster        | is_rest_encrypted                                     | Check if the Elastic Cache is configured with `AtRestEncryptionEnabled`                                                        | True                                                                   | False | Enabled  |
| AwsElastiCacheCacheCluster        | is_transit_encrypted                                  | Check if the Elastic Cache is configured with `TransitEncryptionEnabled`                                                       | True                                                                   | False | Enabled  |
| AwsElastiCacheCacheCluster        | is_encrypted                                          | Check if the Elastic Cache is encrypted by checking `is_rest_encrypted` and `is_node_to_node_encrypted`                        | True                                                                   | False | Enabled  |
| AwsElastiCacheCacheCluster        | its_associated_with_security_groups                   | Check if the Elastic Cache is associated to Security Groups                                                                    | The list of `SecurityGroups`                                           | False | Enabled  |
| AwsElastiCacheCacheCluster        | its_associated_with_security_group_rules_unrestricted | Check if the Elastic Cache is associated with Security Groups rules that are unrestricted (open to 0.0.0.0/0 or ::/0)          | The list of unrestricted rules                                         | False | Enabled  |
