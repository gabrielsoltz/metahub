"""MetaCheck: AwsElbv2LoadBalancer"""
...
class Metacheck(MetaChecksBase):
    ...
    def parse_finding(self, finding, drilled):
        ...
        self.resource_id = (
            finding["Resources"][0]["Id"].split("loadbalancer")[1].split("/")[1]
            if not drilled
            else drilled.split("loadbalancer/")[1].split("/")[1]
        )
    ...
    def type(self):
        if self.elb.get("Type"):
            return self.elb.get("Type")
        return False
